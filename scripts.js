...
let titles = [
    {"Name":"Naryi Baw Mha Myet Yay Set Myar -Tear Drops on the Clock", "year":1986, "listened":1468, "image": "https://i.scdn.co/image/ab67616d0000b2736ec10c07236cf35fa44db682"},
...
function sortMostListeners()
{
    titles_buffer.sort((a,b) => b.listened - a.listened );
    showCards();
}

function sortLeastListeners()
{
